...
- When a business entity name conflicts with a DAL model name, use an entity-specific alias such as `ShowerRoomEntity` or `TravelCenterEntity`; never use the generic alias `BusinessEntity`.
